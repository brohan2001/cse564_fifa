...
// Initialize visualizations with duplication prevention
function initializeVisualizations() {
    console.log("Initializing visualizations...");
    
    // Before initializing, clear existing content
    clearVisualizationContainers();
    
    // Initialize world map
    if (!visualizationStatus.worldMapInitialized) {
        console.log("Initializing World Map...");
        initializeWorldMap();
        visualizationStatus.worldMapInitialized = true;
    } else {
        console.log("World Map already initialized, skipping");
    }
    
    // Initialize PCP
    if (!visualizationStatus.pcpInitialized) {
        console.log("Initializing PCP...");
        initializePCP();
        visualizationStatus.pcpInitialized = true;
    } else {
        console.log("PCP already initialized, skipping");
    }
    
    // Initialize biplot
    if (!visualizationStatus.biplotInitialized) {
        console.log("Initializing Biplot...");
        initializeBiplot();
        visualizationStatus.biplotInitialized = true;
    } else {
        console.log("Biplot already initialized, skipping");
    }
    
    // Initialize player profile
    if (!visualizationStatus.playerProfileInitialized) {
        console.log("Initializing Player Profile...");
        initializePlayerProfile();
        visualizationStatus.playerProfileInitialized = true;
    } else {
        console.log("Player Profile already initialized, skipping");
    }
}

// Clear visualization containers to prevent duplication
function clearVisualizationContainers() {
    ...
    // Clear PCP
    const pcpContainer = document.getElementById('pcp');
    if (pcpContainer) {
        pcpContainer.innerHTML = '';
    }
    
    // Clear Biplot
    const biplotContainer = document.getElementById('biplot');
    if (biplotContainer) {
        biplotContainer.innerHTML = '';
    }
    
    // Clear Player Profile components
    ...
    if (playerInfo) {
        playerInfo.innerHTML = '<p>No player selected</p>';
    }
}
